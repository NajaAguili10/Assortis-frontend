...
import {
  ...
  canAccessTraining,
  canAccessProjectsOrganizationsScoring,
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'projects/organizations-scoring', Component: withPermissionProtection(ProjectsOrganizationsScoring, canAccessProjectsOrganizationsScoring) },
