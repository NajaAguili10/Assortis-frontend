...
import {
  ...
  getTestAccounts,
  type IncompleteSignupData,
} from '@app/services/userStatusService';
...
const Login = () => {
  ...
  const [incompleteSignupData, setIncompleteSignupData] =
      useState<IncompleteSignupData | null>(null);
  ...
  const handleContinueSignup = () => {
    if (incompleteSignupData) {
      localStorage.setItem(
          'assortis_resume_signup',
          JSON.stringify(incompleteSignupData)
      );
                ...
                <div className="bg-white rounded-xl border-2 border-gray-200 p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 mb-6">
                    ...
                    <span className="text-gray-600">
                      ...
                      <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-600">
                      {t('auth.login.accountStatus')}
                    </span>
                        <span className="text-orange-600 font-semibold">
                      {t('auth.login.statusIncomplete', {
                        step: incompleteSignupData.currentStep,
                      })}
                    </span>
                      </div>
          ...
          {showTestAccounts && (
              <div className="mt-6 bg-white rounded-xl border-2 border-gray-200 p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-2">
                    {getTestAccounts().complete.map((account) => (
                        <div
                            key={account.email}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {getTestAccounts().incomplete.map((account) => (
                        <div
                            key={account.email}
