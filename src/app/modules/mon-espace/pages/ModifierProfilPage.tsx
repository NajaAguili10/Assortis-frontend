...
export default function ModifierProfilPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <SubMenu
        items={[
          { label: t('monEspace.nav.publish'), icon: PlusCircle, onClick: () => navigate('/mon-espace/publier') },
          { label: t('monEspace.nav.projectOffers'), icon: Briefcase, onClick: () => navigate('/mon-espace/offres-projets') },
          { label: t('monEspace.nav.internalOffers'), icon: Building2, onClick: () => navigate('/mon-espace/offres-internes') },
          { label: t('monEspace.nav.invitations'), icon: Inbox, onClick: () => navigate('/compte-utilisateur/invitations') },
          { label: t('monEspace.nav.myCV'), icon: FileUser, onClick: () => navigate('/mon-espace/mon-cv') },
          { label: t('monEspace.nav.myAccount'), icon: UserCheck, onClick: () => navigate('/compte-utilisateur/mon-compte') },
        ]}
      />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="bg-white rounded-lg border p-6 mb-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-primary">
                  {t('monEspace.myAccount.sections.newsletter')}
                </h2>
              </div>

              <p className="text-sm text-muted-foreground mb-6">
                {t('monEspace.myAccount.newsletter.description')}
              </p>
              ...
              <div className="space-y-4">
                ...
                <div
                  ...
                  className={`cursor-pointer group relative overflow-hidden rounded-lg p-4 transition-all duration-200 border-2 ${
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-base font-semibold text-primary mb-1">
                        {t('monEspace.myAccount.newsletter.tenders')}
                      </h4>
                      <p className="text-sm text-muted-foreground">
                        {t('monEspace.myAccount.newsletter.tendersDesc')}
                      </p>
                    </div>
                    {formData.newsletterTenders && (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-base font-semibold text-primary mb-1">
                        {t('monEspace.myAccount.newsletter.training')}
                      </h4>
                      <p className="text-sm text-muted-foreground">
                        {t('monEspace.myAccount.newsletter.trainingDesc')}
                      </p>
                    </div>
                    {formData.newsletterTraining && (
                      <div className="flex-shrink-0">
                ...
                {/* Jobs Newsletter - For Experts */}
                <div
                  onClick={() => handleInputChange('newsletterJobs', !formData.newsletterJobs)}
                  className={`cursor-pointer group relative overflow-hidden rounded-lg p-4 transition-all duration-200 border-2 ${
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`rounded-lg p-2 transition-colors duration-200 ${
                      formData.newsletterJobs ? 'bg-accent' : 'bg-gray-100 group-hover:bg-accent/20'
                    }`}>
                      <Briefcase className={`h-5 w-5 ${
                        formData.newsletterJobs ? 'text-white' : 'text-gray-600 group-hover:text-accent'
                      }`} strokeWidth={2} />
                    </div>
                    <div className="flex-1">
                      <h4 className="text-base font-semibold text-primary mb-1">
                        {t('monEspace.myAccount.newsletter.jobs')}
                      </h4>
                      <p className="text-sm text-muted-foreground">
                        {t('monEspace.myAccount.newsletter.jobsDesc')}
                      </p>
                    </div>
                    {formData.newsletterJobs && (
                      <div className="flex-shrink-0">
